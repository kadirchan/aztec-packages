...
template <typename FF_> class mainImpl {
  public:
    ...
    static constexpr std::array<size_t, 81> SUBRELATION_PARTIAL_LENGTHS{
        3, 3, 3, 3, 3, 3, 5, 5, 3, 3, 3, 3, 5, 4, 4, 3, 3, 3, 3, 3, 3, 4, 3, 3, 3, 3, 3,
        3, 3, 3, 3, 3, 3, 2, 5, 3, 3, 3, 4, 4, 3, 3, 3, 4, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3,
        3, 3, 3, 3, 3, 3, 3, 3, 3, 4, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 2,
    };
                           ...
                           [[maybe_unused]] const FF& scaling_factor)
    {
        ...
        // Contribution 18
        {
            ...
            auto tmp = (((((((((((main_sel_op_sender + main_sel_op_address) + main_sel_op_storage_address) +
            ...
            auto tmp =
                (((((main_sel_gas_accounting_active -
                     (((((((main_sel_op_fdiv +
                        ...
                        ((((((((((main_sel_op_sender + main_sel_op_address) + main_sel_op_storage_address) +
                                main_sel_op_chain_id) +
                               main_sel_op_version) +
                              main_sel_op_block_number) +
                             main_sel_op_coinbase) +
        ...
        // Contribution 48
        {
            ...
            auto tmp = (main_sel_op_sender * (kernel_kernel_in_offset - FF(0)));
            tmp *= scaling_factor;
        ...
        // Contribution 50
        {
            ...
            auto tmp = (main_sel_op_storage_address * (kernel_kernel_in_offset - FF(2)));
            tmp *= scaling_factor;
